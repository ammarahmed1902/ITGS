...
export type AdminSection = 'Blog' | 'Jobs' | 'Applications' | 'User Management';

/** Which sections each role can access */
export const ROLE_PERMISSIONS: Record<UserRole, AdminSection[]> = {
  super_admin: ['Blog', 'Jobs', 'Applications', 'User Management'],
  blog_editor: ['Blog'],
...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  super_admin: 'Full access: Blog, Jobs, Applications & User Management.',
